...
public class RTsound3_0 extends PApplet {
...
public void serialEvent(Serial myPort) {
  ...
  if (val!= null) { //We have a reading! Record it.
    ...
    if (PApplet.parseFloat(val) == startCode) {
      out.playNote( 0.0f, 0.4f, "C3" );
      out.playNote( 0.2f, 0.2f, "C4" );
      out.resumeNotes();
      fillColor="green";
    } else if (PApplet.parseFloat(val) == earlyCode) {
      println("You pressed the button too early!");
      fillColor="red";
      out.playNote( 0, 2, "A1");
      out.resumeNotes();
    } else if (PApplet.parseFloat(val) == lateCode){
      ...
      out.playNote( 0.2f, 0.2f, "C4");
      out.playNote( 0.4f, 0.2f, "C4");
      out.resumeNotes();
      fillColor="yellow";
    } 

    float sensorVal = PApplet.parseFloat(val); //parses the packet from Arduino and places the valeus into the sensorVals array. I am assuming floats. Change the data type to match the datatype coming from Arduino. 
    ...
    if (sensorVal != startCode) { // avoids start code to get recorded
      ...
      if (PApplet.parseFloat(val) == earlyCode) {
...
{ 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RTsound3_0" };
    if (passedArgs != null) {
